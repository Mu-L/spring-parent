...
public class Appender {
     ...
     * 文件归档策略
     */
    private LogRollingPolicy rollingPolicy = new LogRollingPolicy();
    /**
     * 异步日志配置
     */
    ...
    public LogRollingPolicy getRollingPolicy() {
        return rollingPolicy;
    }

    public void setRollingPolicy(LogRollingPolicy rollingPolicy) {
